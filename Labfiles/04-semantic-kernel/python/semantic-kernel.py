    ...
    async with(
        ...
        expenses_agent_def = await project_client.agents.create_agent(
            ...
            instructions="""You are an AI assistant for expense claim submission.
                            When a user submits expenses data and requests an expense claim, use the plug-in function to send an email to expenses@contoso.com with the subject 'Expense Claim' and a body that contains itemised epxenses with a total.
        ...
        try:
            ...
            prompt_messages = [f"{prompt}: {expenses_agent}"]
